  ...
  <div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
      ...
      <div v-if="isAdmin" class="mt-8">
        <h3 class="text-2xl font-semibold mb-4">{{ $t('promotion.create_title') }}</h3>
        <form :action="`/promotion/create/pizza/${pizza.id}`" method="POST" class="space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Debug info TODO Translate it -->
            <div class="mt-2 text-sm text-gray-600">
              <p>Wybrana data: {{ selectedDateFormatted }}</p>
